...
const (
	...
	MinSampleValue                tag.ID = 0x0118
	MaxSampleValue                tag.ID = 0x0119
	XResolution                   tag.ID = 0x011a
	YResolution                   tag.ID = 0x011b
	PlanarConfiguration           tag.ID = 0x011c
	PageName                      tag.ID = 0x011d
	XPosition                     tag.ID = 0x011e
	YPosition                     tag.ID = 0x011f
	FreeOffsets                   tag.ID = 0x0120
	FreeByteCounts                tag.ID = 0x0121
	...
	ColorResponseUnit             tag.ID = 0x012c
	TransferFunction              tag.ID = 0x012d
	Software                      tag.ID = 0x0131
	DateTime                      tag.ID = 0x0132 // ModifyDate
	...
	BadFaxLines                   tag.ID = 0x0146
	CleanFaxData                  tag.ID = 0x0147
	ConsecutiveBadFaxLines        tag.ID = 0x0148
	...
	GlobalParametersIFD           tag.ID = 0x0190
	ProfileType                   tag.ID = 0x0191
	FaxProfile                    tag.ID = 0x0192
	CodingMethods                 tag.ID = 0x0193
	VersionYear                   tag.ID = 0x0194
	ModeNumber                    tag.ID = 0x0195
	...
	SonyRawImageSize              tag.ID = 0x7038
	WB_RGGBLevels                 tag.ID = 0x7313
	SonyCropTopLeft               tag.ID = 0x74c7
	SonyCropSize                  tag.ID = 0x74c8
